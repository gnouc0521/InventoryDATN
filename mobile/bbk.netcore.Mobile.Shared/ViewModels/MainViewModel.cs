...
using MvvmHelpers;
using bbk.netcore.Authorization.Users.Profile;
using bbk.netcore.Authorization.Users.Profile.Dto;
using bbk.netcore.Commands;
...
using bbk.netcore.Controls;
using bbk.netcore.Dto;
using bbk.netcore.Extensions;
using bbk.netcore.Localization;
using bbk.netcore.UI;
using bbk.netcore.UI.Assets;
using bbk.netcore.Views;
using DependencyResolver = bbk.netcore.Core.Dependency.DependencyResolver;
...
namespace bbk.netcore.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "netcore";
