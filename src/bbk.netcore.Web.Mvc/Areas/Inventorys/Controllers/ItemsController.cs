      ...
      try
      {
        ...
        using (var stream = new MemoryStream())
        {
          ...
          foreach (var item in itemsModels)
          {
            ...
            if (item.KindCode == null)
            {
              throw new UserFriendlyException("Dòng" + k.ToString() + " Loại hàng không có trong quy cách");
            }
            ...
            {
              throw new UserFriendlyException("Dòng" + k.ToString() + " Ngành hàng không có trong quy cách");
            }
            ...
            {
              throw new UserFriendlyException("Dòng" + k.ToString() + " Nhóm hàng không có trong quy cách");
            }
