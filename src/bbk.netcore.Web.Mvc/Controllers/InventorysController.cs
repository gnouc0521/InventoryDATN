...
using bbk.netcore.Web.Models.Account;
using bbk.netcore.Web.Views.Shared.Components.TenantChange;
using Microsoft.Extensions.Configuration;

namespace bbk.netcore.Web.Controllers
{
    public class InventorysController : netcoreControllerBase
    {
