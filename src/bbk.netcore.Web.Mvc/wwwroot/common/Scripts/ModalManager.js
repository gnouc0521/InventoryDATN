...
(function ($) {
    ...
    app.ModalManager = (function () {
        ...
        function _createContainerWithType(modalId, modalType) {
            _removeContainer(modalId);
        ...
        //function _checkResponseError(response) {
        //    try {
        ...
        return function (options) {
            ...
            var _modalType = options.modalType;
            ...
            var _open = function (args, getResultCallback) {
                ...
                abp.ui.setBusy($("body"));
                if (_modalType) {
                    _createContainerWithType(_modalId, _modalType)
                        .find('.modal-content')
                        .load(options.viewUrl, _args, function (response, status, xhr) {
                            ...
                            try {
                                var jsonRes = JSON.parse(response);
                                if (!jsonRes.success) {
                                    abp.message.warn(abp.localization.abpWeb(jsonRes.error.message));
                                    abp.ui.clearBusy($("body"));
                                    return;
                                }
                            } catch (e) { }
