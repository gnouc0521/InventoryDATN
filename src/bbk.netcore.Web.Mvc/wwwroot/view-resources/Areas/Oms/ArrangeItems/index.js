(function () {
  ...
  var OptionLocation = {
    ...
    //FloorId: ,
    //BlockId: ,
    selectShelfIds: $('#ArrangeItemsTable select.ShelfId'),
    selectFloorIds: $('#ArrangeItemsTable select.FloorId'),
    selectBlockIds: $('#ArrangeItemsTable select.BlockId'),
    showOption: function () {
      $.each(this.selectShelfIds, function (index, selectShelfId) {
        var warehouseId = $(selectShelfId).attr('data-warehouseId');
