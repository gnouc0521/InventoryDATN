(function () {
    ...
    var _createModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Inventorys/ImportRequest/CreateIMP',
        scriptUrl: abp.appPath + 'view-resources/Areas/Oms/ImportRequests/_CreateImpModal.js',
        modalClass: 'ImportRequestCreateModal',
        modalType: 'modal-xl'
    });

    var _EditModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Inventorys/ImportRequest/EditImp',
