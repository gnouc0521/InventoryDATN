(function ($) {
    ...
    app.modals.ProducerCreateModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            _frmproducer = _modalManager.getModal().find('form[name=frmCreate]');
            ...
            function loadSelectAdress(filePath, superiorId, idSelect, txt) {
                ...
                _producerService.getAddress(filePath, superiorId).done((result) => {
