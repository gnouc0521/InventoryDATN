(function () {
    ...
    var _createModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Inventorys/WarehouseTypes/CreateWarehouseType',
        scriptUrl: abp.appPath + 'view-resources/Areas/Oms/WarehouseTypes/_CreateModal.js',
        modalClass: 'WarehouseTypeCreateModal',
        modalType: 'modal-xl'
    ...
    var dataTable = _$unitsTable.DataTable({
        ...
        pageLength: 10,
        listAction: {
            ajaxFunction: _warehouseTypesService.getAll,
