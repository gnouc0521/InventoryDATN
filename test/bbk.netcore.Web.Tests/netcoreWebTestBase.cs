...
{
    public abstract class netcoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static netcoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(netcoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<netcoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<netcoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<netcoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<netcoreDbContext, Task<T>> func)
        {
            T result;
